...
export default function ContasPage(){
  ...
  const [form,setForm]=useState({ unidadeId:"", tipo:"ENERGIA", referencia: new Date().toISOString().slice(0,7), valorTotal:"", criterioRateio:"Medição individual", dataVencimento: new Date().toISOString().slice(0,10), status:"ABERTA", valorDemonstrativo:"", descricaoDemonstrativo:"", exibirDemonstrativo: true });
  ...
  async function criar(e: React.FormEvent){
    e.preventDefault();
    const payload:any = { ...form, valorTotal: Number(form.valorTotal), dataEmissao: new Date().toISOString(), dataVencimento: new Date(form.dataVencimento).toISOString(), valorDemonstrativo: form.valorDemonstrativo? Number(form.valorDemonstrativo): null };
    ...
    if(res.ok) { setForm({ unidadeId:"", tipo:"ENERGIA", referencia: new Date().toISOString().slice(0,7), valorTotal:"", criterioRateio:"Medição individual", dataVencimento: new Date().toISOString().slice(0,10), status:"ABERTA", valorDemonstrativo:"", descricaoDemonstrativo:"", exibirDemonstrativo: true }); load(); }
    else {
