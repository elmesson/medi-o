  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-zinc-50">
      <form onSubmit={step==="login"?doLogin:doMfa} className="w-full max-w-sm bg-white rounded-3xl p-6 shadow-sm border border-zinc-100 space-y-4">
        ...
        <h1 className="text-xl font-bold">Entrar no Portal do Inquilino</h1>
        <p className="text-sm text-muted">Acesso restrito às suas unidades vinculadas.</p>
        {step==="login" ? <>
        ...
        <div className="text-xs text-muted text-center">Demo: demo@elmesson.com.br / demo123 • Sem MFA por padrão. Ative no perfil.</div>
      </form>
    </main>
  );
}
